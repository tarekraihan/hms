...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2019 at 04:15 PM
...
(1, 'Sushant Verma', 'laboratorist@laboratorist.com', 'laboratorist', 'Mumbai, India', '9800000000');
...
(3, 'Tarek', 'tarek@yahoo.com', '123456', 'Mohakhali', '01911222952', 'male', '1985-08-02', 32, 'A+', 1552804214);
...
(3, 1552804480, 1, 3, 'back pain', '1. Napa<br>2. testing medican', '', '');
...
(1, 'birth', 'Patient died for colera', 1552804298, 0, 0);
...
(1, 'system_name', 'Farazi Hospital'),
(7, 'system_email', 'info2015@freephpsoftwares.com'),
(2, 'system_title', 'FPS Hospital Management System'),
(3, 'address', 'Mumbai, India'),
(4, 'phone', '9000090000'),
...
--
ALTER TABLE `blood_donor`
  MODIFY `blood_donor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
